/*
  ...
  - You are about to drop the column `SurfaceArea` on the `Product` table. All the data in the column will be lost.
  - You are about to drop the column `productName` on the `Product` table. All the data in the column will be lost.
  - Added the required column `areaInSft` to the `Product` table without a default value. This is not possible if the table is not empty.
  - Added the required column `mainPartNo` to the `Product` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Product" ("TotalSurfaceAreaProduced", "dailyRecordId", "description", "id", "monthlyRecordId", "yearlyRecordId") SELECT "TotalSurfaceAreaProduced", "dailyRecordId", "description", "id", "monthlyRecordId", "yearlyRecordId" FROM "Product";
DROP TABLE "Product";
